...
static CImage player1_image;
static CImage player2_image;
static CImage blank_image;
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT iMessage, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:
		...
		if (!START)
		{
			...
			case 0:
				blank_image.Draw(memdc, 50, 300, 100, 150, 0, 0, 1417, 1984);
				blank_image.Draw(memdc, 300, 300, 100, 150, 0, 0, 1417, 1984);

				break;

			case 1:
				player1_image.Draw(memdc, 50, 300, 100, 150, 0, 0, 1417, 1984);
				blank_image.Draw(memdc, 300, 300, 100, 150, 0, 0, 1417, 1984);
			...
			case 2:
				player1_image.Draw(memdc, 50, 300, 100, 150, 0, 0, 1417, 1984);
				player2_image.Draw(memdc, 300, 300, 100, 150, 0, 0, 1417, 1984);
				break;
...
void gameValueInit()
{
	...
	player1_image.Load(TEXT("player1_image.jpg"));
	player2_image.Load(TEXT("player2_image.jpg"));
	blank_image.Load(TEXT("blank_image.jpg"));
