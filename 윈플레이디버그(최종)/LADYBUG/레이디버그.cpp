...
//int check_collision(BUG* bug, Move* item)// 충돌 체크
//{
//
//	if (bug->state != 0)
//	{
...
/*	static BOOL sp_bug=false;
	...
	//
	//static Move Barrier[10];//꽃잎 보호막
	//static Move Bee[10];// 벌
	//static Move Baby_bug[10][24];// 베이비 버그
	//static Move CM_line[10];// 일자 코스모스
	...
	case WM_CREATE:
		...
		//S_BUG.Load(TEXT("특수 적.bmp"));
		//BEE.Load(TEXT("벌.png"));
		//BABYBUG.Load(TEXT("베이비 버그.bmp"));
		//COSMOS.Load(TEXT("일자 코스모스.bmp"));
		//BARRIER.Load(TEXT("꽃잎 보호막3.png"));
		...
		BUG.Load(TEXT("적.bmp"));
		//INTERRUPT_ITEM1.Load(TEXT("방해1.png"));
